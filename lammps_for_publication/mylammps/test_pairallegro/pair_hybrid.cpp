  ...
  map(nullptr), special_lj(nullptr), special_coul(nullptr), compute_tally(nullptr)
{
  ...
  outerflag = 0;
  respaflag = 0;
  std::cout<< " in pair hybride construct"<<std::endl;
}
...
PairHybrid::~PairHybrid()
{
  ...
  delete [] svector;
  std::cout<< " in pair hybride deconstruct"<<std::endl;
  if (allocated) {
...
{ std::cout<< " in pair hybride compute"<<std::endl;
  int i,j,m,n;
...
{ std::cout<< " in pair hybride add_tally_callback"<<std::endl;
  for (int m = 0; m < nstyles; m++)
...
{ std::cout<< " in pair hybride del_tally_callback"<<std::endl;
  for (int m = 0; m < nstyles; m++)
...
{ std::cout<< " in pair hybride compute_inner"<<std::endl;
  for (int m = 0; m < nstyles; m++)
...
{ std::cout<< " in pair hybride compute_middle"<<std::endl;
  for (int m = 0; m < nstyles; m++)
...
{ std::cout<< " in pair hybride compute_outer"<<std::endl;
  outerflag = 1;
  compute(eflag,vflag);
  outerflag = 0;
}
...
{ std::cout<< " in pair hybride allocate"<<std::endl;
  allocated = 1;
  int n = atom->ntypes;
...
{ std::cout<< " in pair hybride settings"<<std::endl;
...
{ std::cout<< " in pair hybride flags"<<std::endl;
  int m;
  ...
  std::cout<< " in pair hybride flags single_enable "<<single_enable<<std::endl;
...
{ std::cout<< " in pair hybride init_svector"<<std::endl;
...
{ std::cout<< " in pair hybride coeff"<<std::endl;
...
{ std::cout<< " in pair hybride init_style"<<std::endl;
...
{  std::cout<< " in pair hybride init_one"<<std::endl;
...
{ std::cout<< " in pair hybride setup"<<std::endl;
...
{ std::cout<< " in pair hybride write_restart"<<std::endl;
...
{ std::cout<< " in pair hybride read_restart"<<std::endl;
  int me = comm->me;
...
double PairHybrid::single(int i, int j, int itype, int jtype,
                          ...
                          double &fforce)
{ std::cout<< " in pair hybride single"<<std::endl;
  if (nmap[itype][jtype] == 0)
